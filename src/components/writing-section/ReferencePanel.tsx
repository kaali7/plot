                      ...
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <div className="flex space-x-1 opacity-0 group-hover:opacity-100 transition-opacity">
                          <button 
                            ...
                            title="Insert Name"
                            className="p-1.5 bg-white/5 hover:bg-editor-magenta/20 rounded-md text-white/40 hover:text-editor-magenta transition-all"
                          >
                          ...
                          <button 
                            ...
                            className="p-1.5 bg-white/5 hover:bg-blue-500/20 rounded-md text-white/40 hover:text-blue-400 transition-all"
                          >
