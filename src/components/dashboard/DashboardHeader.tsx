  ...
  return (
    <div className="flex flex-col items-start px-8 py-12 border-b border-editor-border">
      ...
      <div className="flex items-center space-x-3 mb-4">
        <div className="w-6 h-6 bg-magenta-gradient flex items-center justify-center shadow-magenta-glow rounded-sm">
        ...
        <span className="text-[10px] font-mono text-editor-magenta uppercase tracking-[0.3em] font-bold">Plot Studio</span>
      </div>
      
      <h1 className="text-3xl font-serif font-bold text-white leading-tight tracking-tight mb-2 truncate w-full">
        {story.name || 'Untitled Story'}
      </h1>
      
      {story.theme && (
        <div className="flex items-center space-x-2">
          <p className="text-editor-text-muted text-[10px] font-mono uppercase tracking-[0.2em] italic">Theme: {story.theme}</p>
        </div>
      )}
    </div>
  );
