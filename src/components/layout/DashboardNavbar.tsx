          ...
          {user ? (
            ...
            <>
              ...
              <button 
                ...
                className="flex items-center space-x-2 text-sm font-sans font-bold tracking-wide text-white bg-primary hover:bg-white hover:text-black shadow-primary-glow transition-all rounded-full px-5 py-2"
              >
                <FaSignOutAlt className="w-3.5 h-3.5" />
                <span>Log In</span>
              </button>
