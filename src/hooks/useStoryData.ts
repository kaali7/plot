...
export const useStoryManager = (storyId: string): StoryManager => {
  ...
  const addCharacter = useCallback(async (characterData: Partial<Character>) => {
    ...
    const tempCharacter: Character = {
      ...
      motivation: characterData.motivation || { goal: undefined, fear: undefined, desire: undefined },
      traits: characterData.traits || { strengths: [], weaknesses: [], personality: [] },
      conflicts: characterData.conflicts || { internal: undefined, external: undefined },
      relationships: characterData.relationships || [],
      arc: characterData.arc || { start: undefined, end: undefined },
      resources: [],
  ...
  const addScene = useCallback(async (sceneData: Partial<Scene>) => {
    ...
    const tempScene: Scene = {
      ...
      goal: sceneData.goal,
      setting: sceneData.setting || { location: undefined, time: undefined, environment: undefined },
      characters: sceneData.characters || [],
      events: sceneData.events || { main: undefined, turningPoint: undefined },
      conflicts: sceneData.conflicts || { internal: undefined, external: undefined },
